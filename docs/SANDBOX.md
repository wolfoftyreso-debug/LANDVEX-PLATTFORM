...
| Role | Email | Password |
|---|---|---|
| Admin (back office) | `admin@balticbridge.example` | `change-me-now` |
| Ops (back office) | `ops@balticbridge.example` | `change-me-now` |
| Supplier — Vilnius Weldworks (verified) | `supplier1@demo.balticbridge.example` | `demo-password-123` |
| Supplier — Kaunas Steel Fitters (verified) | `supplier2@demo.balticbridge.example` | `demo-password-123` |
| Suppliers 3–10 (various states) | `supplier3..10@demo.balticbridge.example` | `demo-password-123` |
