...
- Detailed deployment: `docs/AWS-DEV-HANDOFF.md`, `infra/aws-notes.md`,
...
| `ARCHITECTURE.md` | Design decisions, data flow, roadmap |
| `README.md` | Overview + run instructions |
| `docs/AWS-DEV-HANDOFF.md` | AWS deployment handoff |
| `docs/production-readiness.md` | Readiness status + gaps |
| `docs/BUILD-STATE-PROMPT.md` | Open decisions (domain/port, quiXzoom, plans) |
