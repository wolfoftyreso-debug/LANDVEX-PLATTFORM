...
/** Target markets for the defensive SEO campaign. Sweden is the live
 * corridor; Norway/Denmark pages capture demand ahead of corridor launch
 * (corridors are seed data — Section 2). */
const MARKETS = ["sweden", "norway", "denmark"] as const;
type Market = (typeof MARKETS)[number];

const MARKET_META: Record<Market, { country: string; live: boolean }> = {
  sweden: { country: "SE", live: true },
  norway: { country: "NO", live: false },
  denmark: { country: "DK", live: false },
};
  ...
  const jsonLd = [
    {
      ...
      "@type": "Service",
      name: t("metaTitle"),
      provider: { "@type": "Organization", name: "Baltic Bridge" },
