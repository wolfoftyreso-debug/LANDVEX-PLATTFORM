...
ADAPTERS: tuple[dict, ...] = (
    ...
    {"id": "livability", "name": "Livability KPIs (Kolada SE / Eurostat EU)",
     "env": "LANDVEX_KOLADA_URL", "alt_env": "LANDVEX_EUROSTAT_LIVE",
     "provides": ["care_supply", "education_outcomes", "crime_index",
                  "healthcare_access", "housing_affordability"],
     "official": "Kolada (RKA) municipal KPIs; Eurostat SILC/price/crime",
     "default_on": False},
