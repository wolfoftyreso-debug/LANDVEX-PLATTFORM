...
PLAN_DATA: dict[str, PlanSpec] = {
    ...
    "cykelverkstad": PlanSpec((60, 150), (150, 500), (0.08, 0.15), (),
                              ("Bicycle wholesaler", "Tools & workshop space",
                               "POS system")),
    # ── Hälsa & vård ────────────────────────────────────────────────
    "fysioterapi": PlanSpec((60, 160), (250, 800), (0.10, 0.18),
                            ("sjukskoterska",),
                            ("Treatment equipment", "Booking & journal system",
                             "Regional care agreement", "Insurance provider")),
    "psykolog": PlanSpec((25, 80), (60, 250), (0.15, 0.28), ("sjukskoterska",),
                         ("Journal system", "Supervision",
                          "Regional care agreement", "Professional insurance")),
    "vardcentral": PlanSpec((300, 900), (1500, 5000), (0.04, 0.10),
                            ("sjukskoterska", "underskoterska"),
                            ("Medical equipment", "Journal system",
                             "Lab services", "Regional care contract")),
    "hudvard": PlanSpec((40, 120), (300, 1200), (0.10, 0.20), (),
                        ("Clinical equipment", "Product wholesaler",
                         "Booking system", "Certification & training")),
    # ── Bygg & fastighet ────────────────────────────────────────────
    "taklaggare": PlanSpec((0, 250), (400, 1500), (0.07, 0.14),
                           ("snickare", "plattsattare"),
                           ("Roofing materials wholesaler", "Lift & scaffolding",
                            "Vehicle & trailer", "Fall-protection certification")),
    "solceller": PlanSpec((0, 300), (400, 1600), (0.08, 0.16),
                          ("elektriker", "drifttekniker"),
                          ("Panel & inverter wholesaler", "Mounting systems",
                           "Vehicle leasing", "Electrical authorization")),
    "glasmasteri": PlanSpec((80, 300), (350, 1200), (0.08, 0.15),
                            ("snickare",),
                            ("Glass wholesaler", "Cutting & edging equipment",
                             "Service vehicle", "Insurance-claim agreements")),
    "tradgard": PlanSpec((0, 200), (200, 900), (0.08, 0.16), ("maskinforare",),
                         ("Machinery (mowers, chippers)", "Plant nursery",
                          "Vehicle & trailer", "Seasonal labour")),
    "fastighetsservice": PlanSpec((0, 250), (150, 800), (0.07, 0.14),
                                  ("fastighetstekniker", "drifttekniker"),
                                  ("Service vehicles", "Tools & equipment",
                                   "Property management contracts",
                                   "Cleaning supplies")),
    # ── Fordon & transport ──────────────────────────────────────────
    "dackverkstad": PlanSpec((150, 500), (400, 1500), (0.08, 0.16), (),
                             ("Tyre wholesaler", "Balancing & mounting machines",
                              "Storage (hotel) racking", "Booking system")),
    "bilhandel": PlanSpec((400, 2000), (2000, 9000), (0.03, 0.08), (),
                          ("Vehicle supply / auctions", "Financing partner",
                           "Workshop equipment", "Warranty provider")),
    # ── Tjänster till företag ───────────────────────────────────────
    "redovisning": PlanSpec((30, 150), (60, 250), (0.15, 0.30), (),
                            ("Accounting software", "Payroll system",
                             "Professional liability insurance",
                             "Authorization (branschorganisation)")),
    "juridik": PlanSpec((40, 200), (80, 350), (0.18, 0.35), (),
                        ("Case management system", "Legal databases",
                         "Professional liability insurance", "Bar membership")),
    "it_support": PlanSpec((30, 200), (150, 700), (0.12, 0.24), ("it_tekniker",),
                           ("Hardware distributor", "RMM & ticketing tools",
                            "Cloud/licence reselling", "Service vehicles")),
    "rekrytering": PlanSpec((40, 200), (80, 400), (0.12, 0.25), (),
                            ("ATS/recruitment system", "Job-ad channels",
                             "Assessment tools", "Payroll & employer services")),
    "coworking": PlanSpec((400, 2500), (1200, 5000), (0.06, 0.15), (),
                          ("Furnishing & fit-out", "Access & booking system",
                           "Connectivity provider",
                           "Lease agreement (main risk)")),
    # ── Handel, besök & hushåll ─────────────────────────────────────
    "hotell": PlanSpec((600, 4000), (3000, 15000), (0.06, 0.16), ("kock",),
                       ("Property lease or purchase", "Booking channels & PMS",
                        "Housekeeping & laundry", "Furnishing & fit-out")),
    "padel": PlanSpec((800, 3000), (2000, 7000), (0.10, 0.22), (),
                      ("Court construction", "Booking & access system",
                       "Premises lease (industrial)", "Pro shop supplier")),
    "djuraffar": PlanSpec((100, 400), (350, 1400), (0.05, 0.12), (),
                          ("Pet food & supplies wholesaler", "Shop fittings",
                           "POS system", "Live-animal regulations (permits)")),
    "tvatteri": PlanSpec((80, 300), (450, 2000), (0.07, 0.15), (),
                         ("Industrial washers & dryers", "Detergent supplier",
                          "Service contract for machines",
                          "Business laundry contracts")),
